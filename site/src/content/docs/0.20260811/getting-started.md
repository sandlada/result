...
slug: 0.20260811/getting-started
---
...
* [Behavior modes](/0.20260811/behavior-modes/) — which APIs throw, which capture, and which short-circuit.
* [API Reference](/0.20260811/api/) — every export, generated from the source JSDoc.
