...
Defined in: [primitives/partitionOption.ts:25](https://github.com/sandlada/result/blob/main/src/primitives/partitionOption.ts#L25)
...
Defined in: [primitives/partitionOption.ts:27](https://github.com/sandlada/result/blob/main/src/primitives/partitionOption.ts#L27)

##### some

> `readonly` **some**: readonly `T`\[]

Defined in: [primitives/partitionOption.ts:26](https://github.com/sandlada/result/blob/main/src/primitives/partitionOption.ts#L26)
...
Defined in: [primitives/cond.ts:28](https://github.com/sandlada/result/blob/main/src/primitives/cond.ts#L28)
...
Defined in: [primitives/condErr.ts:23](https://github.com/sandlada/result/blob/main/src/primitives/condErr.ts#L23)
...
Defined in: [primitives/lift.ts:37](https://github.com/sandlada/result/blob/main/src/primitives/lift.ts#L37)
...
Defined in: [primitives/lift.ts:40](https://github.com/sandlada/result/blob/main/src/primitives/lift.ts#L40)
...
Defined in: [primitives/partitionOption.ts:33](https://github.com/sandlada/result/blob/main/src/primitives/partitionOption.ts#L33)
...
Defined in: [primitives/reduce.ts:29](https://github.com/sandlada/result/blob/main/src/primitives/reduce.ts#L29)
...
Defined in: [primitives/sequence.ts:27](https://github.com/sandlada/result/blob/main/src/primitives/sequence.ts#L27)
...
Defined in: [primitives/sequenceAsyncResult.ts:26](https://github.com/sandlada/result/blob/main/src/primitives/sequenceAsyncResult.ts#L26)
