...
export function mapAsync<A, B, E>(
    ...
    if (r === undefined) {
        return <E>(r: AsyncResult<A, E>): AsyncResult<B, E> => r.mapAsync(f);
    }
    return r.mapAsync(f);
}
...
export function mapErrAsync<A, E, F>(
    ...
    if (r === undefined) {
        return <A>(r: AsyncResult<A, E>): AsyncResult<A, F> => r.mapErrAsync(f);
    }
    return r.mapErrAsync(f);
}
 ...
 * `fn` can return `AsyncResult<B, F>` or `IResultOfT<B, F>`.
 *
...
export function bind<A, B, F>(
    f: (a: A) => AsyncResult<B, F> | IResultOfT<B, F>,
...
export function orElse<E, B, F>(
    f: (e: E) => AsyncResult<B, F> | IResultOfT<B, F>,
